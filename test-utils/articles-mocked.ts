...
export const getAMockedArticle = () => [
  {
    ...
    slug: 'titre-de-test',
    title: 'titre de test',
    introduction: "passages du Lorem Ipsum, et, plus récemment, par son inclusion dans des applications de mise en page de texte, comme Aldus PageMaker. Pourquoi l'utiliser? GG",
